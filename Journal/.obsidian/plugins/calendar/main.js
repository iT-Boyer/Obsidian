...
function getDateUIDFromFile(file) {
    ...
    const format = getWeeklyNoteSettings(get_store_value(settings)).format;
 ...
 */
async function configureMomentLocale(localeOverride = "system-default") {
    var _a;
...
function create_default_slot(ctx) {
	...
	return {
		c() {
			...
			attr(div1, "class", div1_class_value = "" + (null_to_empty(`day ${/*metadata*/ ctx[7].classes.join(" ")}`) + " svelte-q3wqg9"));
		...
		p(new_ctx, dirty) {
			...
			if (!current || dirty & /*metadata*/ 128 && div1_class_value !== (div1_class_value = "" + (null_to_empty(`day ${/*metadata*/ ctx[7].classes.join(" ")}`) + " svelte-q3wqg9"))) {
				attr(div1, "class", div1_class_value);
			}

			if (dirty & /*metadata, selectedId, getDateUID, date*/ 193) {
				toggle_class(div1, "active", /*selectedId*/ ctx[6] === getDateUID_1$1(/*date*/ ctx[0], "day"));
			}

			if (dirty & /*metadata, date, displayedMonth*/ 161) {
				toggle_class(div1, "adjacent-month", !/*date*/ ctx[0].isSame(/*displayedMonth*/ ctx[5], "month"));
			}

			if (dirty & /*metadata, date, today*/ 145) {
				toggle_class(div1, "today", /*date*/ ctx[0].isSame(/*today*/ ctx[4], "day"));
			}
		},
		i(local) {
